    ...
    <div style={{ minHeight:'100vh', display:'flex', flexDirection:'column',
      ...
      <motion.div style={{ position:'relative', zIndex:1, width:'100%', maxWidth:360,
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:4 }}>
          <p style={{ fontSize:11, letterSpacing:'0.3em', color:'var(--text-muted)',
            textTransform:'uppercase', fontFamily:"'Space Mono', monospace" }}>JEE</p>
          <h1 style={{ fontSize:36, fontWeight:700, color:'#fff', lineHeight:1,
            fontFamily:"'Space Mono', monospace", letterSpacing:'0.05em' }}>RANKING</h1>
          <p style={{ fontSize:11, letterSpacing:'0.2em', color:'var(--text-muted)',
            textTransform:'uppercase', fontFamily:"'Space Mono', monospace" }}>system</p>
        </div>
        ...
        <div style={{ display:'flex', alignItems:'flex-end', gap:8, justifyContent:'center' }}>
          {PREVIEW.map((r,i) => (
            <motion.div key={r.tier}
              ...
              <RankBadge rank={r} size={i===5?'md':'sm'} animate={i===5}/>
            </motion.div>
          ))}
        </div>
